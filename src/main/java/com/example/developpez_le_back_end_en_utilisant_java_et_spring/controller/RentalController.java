...
public class RentalController {
    ...
    public RentalDto createRental(@RequestBody AddRentalRequestDto rentalRequest) {
    ...
    public RentalDto updateRental(@PathVariable Integer id, @RequestBody UpdateRentalRequestDto rentalUpdateDto) {
